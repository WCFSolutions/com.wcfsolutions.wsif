...
class Category extends DatabaseObject {
	...
	/**
	 * Returns the number of entry comments in this category.
	 *
	 * @return	integer
	 */
	public function getEntryComments() {
		...
		if ($this->entryComments === null) {
			$this->entryCommentss = 0;
			$cache = WCF::getCache()->get('categoryData', 'stats');
			if (isset($cache[$this->categoryID]['entryComments'])) $this->entryComments = $cache[$this->categoryID]['entryComments'];
		}
